...
const AlertSettingsModal = dynamic(() => import("@/components/inventory/alerts").then(mod => mod.AlertSettingsModal), {
    ssr: false,
});
...
function AlertsPageContent() {
    ...
    const companyId = typeof companyObj === 'string' ? companyObj : (companyObj?.id || companyObj?._id || 'demo-company');
    ...
    const fetchAlerts = async () => {
        ...
        try {
            ...
            setAlerts([
                ...
                // ... (truncated other mock data to save space, keeping functionality)
            ]);
        } finally {
            setLoading(false);
        }
    ...
    return (
        <div className="min-h-screen bg-white p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                {/* Add other stats cards here similarly */}
            </div>
...
export default function AlertsPage() {
    return (
        <Suspense fallback={<div className="flex justify-center items-center min-h-screen"><Loader2 className="w-8 h-8 animate-spin text-orange-500" /></div>}>
            <AlertsPageContent />
        </Suspense>
    );
}