...
const dataSlice = createSlice({
  ...
  reducers: {
    ...
    addDocument: (state, action) => { state.items.unshift(action.payload); state.totalCount += 1; },
  ...
  extraReducers(builder) {
    ...
    // Create
    builder.addCase(createDocument.fulfilled, (state, action) => { state.items.unshift(action.payload); });
